...
export function CalloutPanel({ title, body, icon: Icon, actions, id }: CalloutPanelProps) {
  return (
    <section
      id={id}
      className="grid gap-6 rounded-none border border-neutral-400 bg-black p-7 backdrop-blur-[2px] sm:p-8 lg:grid-cols-[1fr_auto] lg:items-center"
    >
