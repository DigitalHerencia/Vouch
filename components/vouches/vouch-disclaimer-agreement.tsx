...
export function VouchDisclaimerAgreement({
  ...
  return (
    <div className="grid gap-4">
      <label className="grid grid-cols-[auto_minmax(0,1fr)] items-start gap-4 bg-black">
        <Checkbox
          checked={checked}
          disabled={disabled}
        ...
        <span className="max-w-prose text-sm leading-7 font-semibold text-neutral-300">
