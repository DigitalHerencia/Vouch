  ...
  return (
    <header className="flex items-center justify-between gap-4 px-6 py-6 sm:px-10 lg:px-14">
      ...
      <Link
        ...
        className="font-(family-name:--font-display) text-xs leading-none tracking-widest text-neutral-100 uppercase underline-offset-4 transition-colors hover:text-blue-600 hover:underline sm:text-sm"
      >
