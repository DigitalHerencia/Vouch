...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <InputPrimitive
      ...
      data-slot="input"
      className={cn(
        "h-12 w-full min-w-0 rounded-none border border-neutral-700 bg-black/70 px-4 py-2 text-base font-semibold text-white transition-colors outline-none placeholder:text-neutral-600",
        ...
        "aria-invalid:border-red-400 aria-invalid:ring-0 md:text-sm",
        className
      )}
      {...props}
    />
