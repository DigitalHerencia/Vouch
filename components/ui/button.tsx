...
const buttonVariants = cva(
  [
    ...
    "font-(family-name:--font-display) leading-none font-normal tracking-widest whitespace-nowrap uppercase",
  ...
  ].join(" "),
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-neutral-700 bg-transparent text-white hover:border-primary hover:bg-transparent hover:text-primary aria-expanded:border-primary aria-expanded:bg-transparent aria-expanded:text-primary",
        ghost:
      ...
      size: {
        ...
        sm: "h-9 gap-2 px-3 text-xs sm:text-sm [&_svg:not([class*='size-'])]:size-3.5",
        lg: "h-12 gap-3 px-5 text-sm sm:text-base [&_svg:not([class*='size-'])]:size-5",
        cta: "h-14 gap-6 px-7 text-center text-sm sm:text-base lg:text-lg [&_svg:not([class*='size-'])]:size-5",
        nav: "h-auto gap-2 px-0 text-sm sm:text-base lg:text-lg",
