...
export interface LandingPublicHeaderNavItem {
  label: string
  href: string
}

export interface LandingPublicHeaderProps {
  logo?: ReactNode | undefined
  navItems?: readonly LandingPublicHeaderNavItem[] | undefined
...
] satisfies readonly LandingPublicHeaderNavItem[]
