...
export function PaymentSettingsPage({ state, startAction, refreshAction }: PaymentSettingsPageProps) {
  ...
  return (
    <section className="mx-auto flex w-full max-w-3xl flex-col gap-4 px-6 py-8">
      ...
      <div className="flex gap-3">
        {startAction ? <form action={startAction}><Button type="submit">Set up payment</Button></form> : null}
