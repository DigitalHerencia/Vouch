        ...
        <div className="relative flex h-full flex-col justify-between p-12">
          ...
          <div className="max-w-xl">
            ...
            <p className="mt-6 text-base leading-7 text-neutral-300">
              Create an account to send or accept commitment-backed payments for appointments and
              in-person agreements.
            </p>
          </div>
          <p className="max-w-lg text-sm leading-6 text-neutral-500">
            Payment-bearing actions require account readiness, verification, payment or payout
            setup, and current terms acceptance.
          </p>
        </div>
      </section>
