                ...
                <div className="relative flex h-full flex-col justify-between p-12">
                    ...
                    <div className="max-w-xl">
                        ...
                        <p className="mt-6 text-base leading-7 text-neutral-300">
                            Sign in to manage Vouches, monitor confirmation windows, and keep
                            payment outcomes deterministic.
                        </p>
                    </div>
                    <p className="max-w-lg text-sm leading-6 text-neutral-500">
                        Vouch is not a marketplace, scheduler, escrow provider, or dispute system.
                        Users bring their own agreement; Vouch coordinates the payment outcome.
                    </p>
                </div>
            </section>
