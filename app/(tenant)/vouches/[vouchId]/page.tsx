  ...
  return (
    <VouchDetailPage
      ...
      paymentStatusLabel={String(
        (v.paymentRecord as Record<string, unknown> | undefined)?.status ?? "not_started"
      )}
      confirmation={{
        payerConfirmed: confirmations.some(
          (c) => c.participantRole === "payer" && c.status === "confirmed"
        ),
        payeeConfirmed: confirmations.some(
          (c) => c.participantRole === "payee" && c.status === "confirmed"
        ),
