        ...
        <section className="grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
          <div className="pt-2 lg:pt-8">
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              ...
              <Link
                href="#process"
                className="inline-flex h-14.5 min-w-55 items-center justify-center gap-6 bg-[#1D4ED8] px-7 text-center font-(family-name:--font-display) text-[14px] leading-none tracking-[0.08em] text-white uppercase transition-colors hover:bg-blue-700"
              >
                How it works
